...
def generate_fact_magnitude(magnitude_path: str, session_path: str):
    ...
    df = df.select(
        ...
        col("Mag N6").alias("cnt_mag_neg_6"),
        col("Mag N5").alias("cnt_mag_neg_5"),
        col("Mag N4").alias("cnt_mag_neg_4"),
        col("Mag N3").alias("cnt_mag_neg_3"),
        col("Mag N2").alias("cnt_mag_neg_2"),
        col("Mag N1").alias("cnt_mag_neg_1"),
        col("Mag 0").alias("cnt_mag_0"),
        col("Mag 1").alias("cnt_mag_1"),
        col("Mag 2").alias("cnt_mag_2"),
        col("Mag 3").alias("cnt_mag_3"),
        col("Mag 4").alias("cnt_mag_4"),
        col("Mag 5").alias("cnt_mag_5"),
        col("Mag 6").alias("cnt_mag_6"),
