...
dim_local_path = "../data/output/dim_local.parquet"
dim_date_path = "../data/output/dim_date.parquet"
dim_time_path = "../data/output/dim_time.parquet"
dim_user_path = "../data/output/dim_user.parquet"
dim_shower_path = "../data/output/dim_shower.parquet"
dim_junk_path = "../data/output/dim_junk.parquet"
fact_observations_path = "../data/output/fact_observations.parquet"
